...
<tr><td><b>Id</b></td><td><CopyableCode code="vercel.web_analytics.event_aggregates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td>Counts custom events on a project, within the requested date range. Results are either aggregated or broken down over time. Results can additionally be broken down by one dimension, and filtered by multiple dimensions.</td>
</tr>
</tbody>
</table>
...
workflow_event_type,
workflow_status
FROM vercel.web_analytics.event_aggregates
