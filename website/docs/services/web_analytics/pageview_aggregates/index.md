...
Creates, updates, deletes, gets or lists a <code>pageview_aggregates</code> resource.

## Overview
<table><tbody>
<tr><td><b>Name</b></td><td><CopyableCode code="pageview_aggregates" /></td></tr>
<tr><td><b>Type</b></td><td>Resource</td></tr>
<tr><td><b>Id</b></td><td><CopyableCode code="vercel.web_analytics.pageview_aggregates" /></td></tr>
</tbody></table>
...
<tr>
    ...
    <td><a href="#parameter-project_id"><code>project_id</code></a>, <a href="#parameter-by"><code>by</code></a>, <a href="#parameter-since"><code>since</code></a>, <a href="#parameter-until"><code>until</code></a></td>
    <td><a href="#parameter-limit"><code>limit</code></a>, <a href="#parameter-filter"><code>filter</code></a>, <a href="#parameter-team_id"><code>team_id</code></a>, <a href="#parameter-slug"><code>slug</code></a></td>
    <td>Counts pageviews on a project, within the requested date range. Results are either aggregated or broken down over time. Results can additionally be broken down by one dimension, and filtered by multiple dimensions.</td>
</tr>
</tbody>
</table>
...
<tr id="parameter-limit">
    ...
    <td>Number of distinct results, default to 10. Other results are grouped into "Others" group.</td>
</tr>
...
workflow_event_type,
workflow_status
FROM vercel.web_analytics.pageview_aggregates
