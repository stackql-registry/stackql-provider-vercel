...
function extractTemplateFromPage() {
  ...
  if (selectH2) {
    ...
    sections.select = extractCodeFromElements(els, 'get (all properties)')
                   || extractCodeFromElements(els, 'get')
  ...
  // --- UPDATE ---
  const updateH2 = document.getElementById('update-examples') || document.getElementById('update-example');
  if (updateH2) {
  ...
  const deleteH2 = document.getElementById('delete-examples') || document.getElementById('delete-example');
  if (deleteH2) {
